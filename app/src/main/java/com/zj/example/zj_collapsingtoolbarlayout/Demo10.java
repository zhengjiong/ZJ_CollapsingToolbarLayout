 ...
 * @version 1.0
 */
public class Demo10 extends AppCompatActivity {
    private int max;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        max = Utils.dip2px(Demo10.this, 46);//editText最大可滑动的距离

        actionbarSize = Utils.dip2px(Demo10.this, 56);
        editInitLeftMargin = Utils.dip2px(Demo10.this, 20);
